...
CREATE TABLE public.classification (
   ...
   --Table structur for table 'inventory'
CREATE TABLE IF NOT EXISTS public.inventory
(
	inv_id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY,
	inv_make VARCHAR(120) NOT NULL,
	inv_model VARCHAR(120) NOT NULL,
	inv_year character(4) NOT NULL,
	inv_description text NOT NULL,
	inv_image VARCHAR(120) NOT NULL,
	inv_thumbnail VARCHAR(120) NOT NULL,
	inv_price numeric(9, 0) NOT NULL,
	inv_miles integer NOT NULL,
	inv_color VARCHAR(120) NOT NULL,
...
-- Create relationships with 'cart' to 'account' table
...
-- Create relationships with 'cart' to 'inventory' table
ALTER TABLE IF EXISTS public.cart
