 ...
 * ********************* */
async function getAcctByEmail(account_email){
 try {
 ...
 *   Get account by ID
 * ********************* */
async function getAcctById(account_id){
 try {
  const result = await pool.query(
...
async function updateInfo(account_firstname, account_lastname, account_email, account_id) {
  try {
    ...
    const data = await pool.query(sql, [ account_firstname, account_lastname,
 ...
 * UPDATE PASSWORD
 ****************************** */
async function updatePwd(account_password, account_id) {
  try {
    const sql =
